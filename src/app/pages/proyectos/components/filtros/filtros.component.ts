...
import { CategoryProyectoModel } from '../../../../core/models/proyecto.model';

@Component({
  selector: 'proyectos-filtros',
  standalone: true,
  imports: [
    CommonModule
  ],
...
export class FiltrosComponent implements OnDestroy {
  ...
  public categories = input.required<CategoryProyectoModel[]>();
  @Output()
  ...
  setCategory(category: CategoryProyectoModel) {
