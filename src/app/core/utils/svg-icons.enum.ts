export enum SvgIcons {
  ...
  `,
  'semicolons' = `
    <svg xmlns="http://www.w3.org/2000/svg" class="w-64 h-64" viewBox="0 0 42 32.667" fill="currentColor">
      <path d="M0 32.667V22.96c0-2.756.53-5.572 1.588-8.447A37.234 37.234 0 0 1 5.78 6.38C7.515 3.834 9.397 1.707 11.426 0l8.295 4.988a44.746 44.746 0 0 0-4.06 8.267c-1.029 2.876-1.543 6.081-1.543 9.616v9.796H0Zm22.28 0V22.96c0-2.756.529-5.572 1.588-8.447s2.455-5.587 4.19-8.133C29.795 3.834 31.677 1.707 33.707 0L42 4.988a44.746 44.746 0 0 0-4.059 8.267c-1.03 2.876-1.544 6.081-1.544 9.616v9.796H22.279Z">
      </path>
    </svg>
  `,
  'arrowRight' = `
  ...
  `,
  'angleRight' = `
    <svg  class="rtl:rotate-180"  aria-hidden="true" xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24">
  ...
  `,
  'instagram' = `
    <svg dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
  ...
  'spinner' = `
    <svg width="60" height="20" viewBox="0 0 120 30">
      ...
      </circle><circle cx="60" cy="15" r="10" fill="#FFF">
      ...
      </circle><circle cx="90" cy="15" r="10" fill="#FFF">
